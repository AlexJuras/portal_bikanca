...
class BannerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $banners = [
            ...
            [
                'nome' => 'Banner Topo - Lista de Vídeos',
                'posicao' => 'videos_topo',
                'pagina' => 'videos',
                'largura' => 728,
                'altura' => 90,
                'ativo' => true,
                'ordem' => 1,
                'descricao' => 'Banner superior da lista de vídeos'
            ],
            [
                'nome' => 'Banner Lateral - Lista de Vídeos',
                'posicao' => 'videos_lateral',
                'pagina' => 'videos',
                'largura' => 300,
                'altura' => 250,
                'ativo' => true,
                'ordem' => 1,
                'descricao' => 'Banner lateral na lista de vídeos'
            ],
            [
                'nome' => 'Banner Meio - Página do Vídeo',
                'posicao' => 'video_meio',
                'pagina' => 'video',
                'largura' => 728,
                'altura' => 90,
                'ativo' => true,
                'ordem' => 1,
                'descricao' => 'Banner no meio do player de vídeo'
            ]
        ];
