...
// Form data com dados do autor
const form = useForm({
    nome: props.autor.nome || '',
    email: props.autor.email || '',
    bio: props.autor.bio || '',
    foto: null
});
...
onMounted(() => {
    if (props.autor.foto) {
        fotoPreview.value = `/storage/${props.autor.foto}`;
    }
});
...
const handleFotoChange = (event) => {
    ...
    if (file) {
        ...
        // Voltar para a foto original se não selecionar arquivo
        if (props.autor.foto) {
            fotoPreview.value = `/storage/${props.autor.foto}`;
        } else {
                ...
                >
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">
                            Atualize as informações de {{ autor.nome }}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <form @submit.prevent="submit" class="space-y-6 p-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-start space-x-6">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    PNG, JPG, GIF até 2MB. Deixe em branco para manter a foto atual.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                        ...
                        >
                            ...
                            <span v-else>Atualizar Autor</span>
                        </button>
                    </div>
                </form>
            </div>
