...
const form = useForm({ nome: "", slug: "", descricao: "" });
                ...
                >
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">
                            Adicione uma nova categoria para organizar as
                            notícias
                        </p>
                    </div>
                </div>
            ...
            <form @submit.prevent="submit">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                URL amigável para a categoria. Será gerada
                                automaticamente baseada no nome.
                            </p>
                            <div
                ...
                <div class="flex justify-end space-x-4 mt-8">
                    ...
                    >
                        ...
                        {{ form.processing ? "Criando..." : "Criar Categoria" }}
                    </button>
                </div>
            </form>
        </div>
