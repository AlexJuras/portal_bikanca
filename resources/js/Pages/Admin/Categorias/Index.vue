    ...
    <div class="container mx-auto p-4">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-2">
                Gerencie todas as categorias do portal
            </p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="categoria in categorias.data" :key="categoria.id" class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4">
                                <div class="text-sm text-gray-900 max-w-xs line-clamp-2">
                                    {{ categoria.descricao || 'Sem descrição' }}
                                </div>
                            </td>
                            <td class="px-4 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    {{ categoria.noticias_count || 0 }} notícias
                                </span>
                            </td>
            ...
            <div class="lg:hidden">
                <div v-for="categoria in categorias.data" :key="categoria.id" class="border-b border-gray-200 p-4">
            ...
            <!-- Paginação -->
            <div v-if="categorias.links && categorias.links.length > 3" class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
...
const debouncedSearch = debounce(() => {
    router.get(route('admin.categorias.index'), { 
        search: search.value 
    }, { 
        preserveState: true,
        replace: true 
