...
const props = defineProps({
    ultimasNoticias: { type: Array, default: () => [] },
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div v-for="(noticia, index) in ultimasNoticias" :key="noticia.id" 
                    ...
                    <div class="relative overflow-hidden">
                        ...
                        <!-- Categoria sobreposta na imagem -->
                        <div class="absolute top-3 left-3">
                            <span class="bg-[#4c54ff] text-white text-xs font-semibold px-3 py-1 rounded-full shadow-lg">
                                {{ noticia.categoria?.nome || 'Sem categoria' }}
                            </span>
                        </div>
                        
                        <!-- Data sobreposta na imagem -->
                        <div class="absolute bottom-3 right-3">
                            <span class="bg-black/70 text-white text-xs font-medium px-2 py-1 rounded-md">
                                {{ new Date(noticia.publicada_em).toLocaleDateString('pt-BR') }}
                            </span>
                        </div>
                    </div>
