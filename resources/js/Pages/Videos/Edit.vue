        ...
        <section class="bg-white shadow-sm border-b">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <nav class="text-sm text-gray-600 mb-4">
                    ...
                    <Link href="/videos" class="hover:text-azul-oxford transition-colors">Vídeos</Link>
                    <span class="mx-2">></span>
                    <Link :href="route('videos.show', video.id)" class="hover:text-azul-oxford transition-colors">{{ video.titulo }}</Link>
                    <span class="mx-2">></span>
                    <span class="text-azul-oxford">Editar</span>
                </nav>
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-2">
                        Edite as informações do vídeo: {{ video.titulo }}
                    </p>
                </div>
            </div>
        </section>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    <!-- URL do YouTube -->
                    <div>
                        <label for="url_externa" class="block text-sm font-medium text-gray-700 mb-2">
                            URL do YouTube *
                        </label>
                        <input 
                            id="url_externa"
                            ...
                            required
                        />
                        <div v-if="form.errors.url_externa" class="text-red-600 text-sm mt-1">
                    ...
                    <!-- Preview do Vídeo -->
                    <div v-if="showPreview && videoPreview" class="bg-gray-50 rounded-lg p-4">
                        <h3 class="text-lg font-medium text-gray-900 mb-3">Preview do Vídeo</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="text-sm text-gray-600">
                                <p><strong>ID do YouTube:</strong> {{ videoPreview.id }}</p>
                                <p><strong>URL de Embed:</strong> {{ videoPreview.embedUrl }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div v-if="form.errors.categoria_id" class="text-red-600 text-sm mt-1">
                        ...
                        <!-- Autor -->
                        <div>
                            <label for="autor_id" class="block text-sm font-medium text-gray-700 mb-2">
                                Autor *
                            </label>
                            <select 
                                id="autor_id"
                            ...
                            <div v-if="form.errors.autor_id" class="text-red-600 text-sm mt-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            />
                            <div v-if="form.errors.duracao" class="text-red-600 text-sm mt-1">
                                {{ form.errors.duracao }}
                            </div>
                        </div>
                    ...
                    <div class="bg-blue-50 rounded-lg p-4">
                        <h3 class="text-sm font-medium text-blue-900 mb-2">Informações do Vídeo</h3>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-blue-800">
                            <div>
                                <strong>Visualizações:</strong> {{ video.visualizacoes || 0 }}
                            </div>
                            <div v-if="video.publicada_em">
                                <strong>Publicado em:</strong> {{ new Date(video.publicada_em).toLocaleDateString('pt-BR') }}
                            </div>
                            <div>
                                <strong>Status atual:</strong> {{ video.status === 'publicada' ? 'Publicado' : 'Rascunho' }}
                            </div>
                        </div>
                    </div>
